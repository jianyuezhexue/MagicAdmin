...
INSERT INTO `menu` (`id`, `parentId`, `icon`, `title`, `path`, `name`, `hidden`, `component`, `sort`, `apis`, `expandAuth`, `createdAt`, `updatedAt`, `deletedAt`) VALUES (18, 3, 'files', '字典管理', 'dictionary', 'dictionary', 0, 'view/superAdmin/dictionary/Dictionary.vue', 5, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `menu` (`id`, `parentId`, `icon`, `title`, `path`, `name`, `hidden`, `component`, `sort`, `apis`, `expandAuth`, `createdAt`, `updatedAt`, `deletedAt`) VALUES (19, 3, 'cherry', '字典详情', 'dictionaryDetail/:id', 'dictionaryDetail', 1, 'view/superAdmin/dictionary/DictionaryDetail.vue', 1, NULL, NULL, NULL, NULL, NULL);
